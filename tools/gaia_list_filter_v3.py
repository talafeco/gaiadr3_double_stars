...
field_names = ['solution_id', 'designation', 'source_id', 'ra', 'dec', 'parallax', 'parallax_error', 'pm', 'pmra', 'pmdec', 'ruwe', 'phot_g_mean_mag', 'phot_bp_mean_mag', 'phot_rp_mean_mag', 'bp_rp', 'bp_g', 'g_rp', 'radial_velocity', 'radial_velocity_error', 'phot_variable_flag', 'non_single_star', 'teff_gspphot']
fields_dtype = ['str', 'str', 'str', 'float64', 'float64', 'str', 'str', 'str', 'str', 'str', 'str', 'float64', 'str', 'str', 'str', 'str', 'float64', 'str', 'str', 'str', 'int64', 'str']

file_data_read = Table.read(filename, names=field_names_read, format='ascii')
