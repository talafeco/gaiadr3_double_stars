...
job = Gaia.launch_job_async("""
    SELECT TOP 100000
        source_id, parallax, parallax_error, phot_g_mean_mag, phot_bp_mean_mag, phot_rp_mean_mag, teff_gspphot
    FROM gaiadr3.gaia_source
    WHERE parallax > 5 AND parallax/parallax_error > 10
...
df.to_csv('star_catalog.csv', index=False)
